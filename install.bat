...
call mvn install:install-file -Dfile=jide-action.jar -DgroupId=jide  -DartifactId=action -Dversion=3.7.11 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
call mvn install:install-file -Dfile=jide-beaninfo.jar -DgroupId=jide  -DartifactId=beaninfo -Dversion=3.7.11 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
call mvn install:install-file -Dfile=jide-charts.jar -DgroupId=jide  -DartifactId=charts -Dversion=3.7.11 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
call mvn install:install-file -Dfile=jide-common.jar -DgroupId=jide  -DartifactId=common -Dversion=3.7.11 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
call mvn install:install-file -Dfile=jide-components.jar -DgroupId=jide  -DartifactId=components -Dversion=3.7.11 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
call mvn install:install-file -Dfile=jide-dashboard.jar -DgroupId=jide  -DartifactId=dashboard -Dversion=3.7.11 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
call mvn install:install-file -Dfile=jide-data.jar -DgroupId=jide  -DartifactId=data -Dversion=3.7.11 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
call mvn install:install-file -Dfile=jide-designer.jar -DgroupId=jide  -DartifactId=designer -Dversion=3.7.11 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
call mvn install:install-file -Dfile=jide-dialogs.jar -DgroupId=jide  -DartifactId=dialogs -Dversion=3.7.11 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
...
call mvn install:install-file -Dfile=jide-plaf-jdk7.jar -DgroupId=jide  -DartifactId=plaf-jdk7 -Dversion=3.7.11 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
call mvn install:install-file -Dfile=jide-properties.jar -DgroupId=jide  -DartifactId=properties -Dversion=3.7.11 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
call mvn install:install-file -Dfile=jide-rss.jar -DgroupId=jide  -DartifactId=rss -Dversion=3.7.11 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
call mvn install:install-file -Dfile=jide-shortcut.jar -DgroupId=jide  -DartifactId=shortcut -Dversion=3.7.11 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true
call mvn install:install-file -Dfile=jide-treemap.jar -DgroupId=jide  -DartifactId=treemap -Dversion=3.7.11 -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true