...
call mvn install:install-file -Dfile=dependencies_xml -DgroupId=com.sia  -DartifactId=common-client-dependency -Dversion=1.2.1 -Dpackaging=pom -DlocalRepositoryPath=.  -DcreateChecksum=true
