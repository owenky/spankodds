...
*/	
    ...
    { 
		...
		{ 
			...
			//	AppController.setDisplayType(display[cb.getSelectedIndex()]);
			//owen took out getting period and siaplay from ltd 
			//ChartView.setItem(display[cb.getSelectedIndex()]);
		...
		{ 
				...
				stb.requestFocusInWindow();
				//owen took out getting period and siaplay from ltd 
				//	ChartView.setPeriod(perioddisplay[periodcb.getSelectedIndex()]);
		...
		Action clearaction = new AbstractAction("Clear") {
				...
				public void actionPerformed(ActionEvent e) {
					System.out.println("clear button pressed");
							//AppController.getLinesTableData().clearColors();
		...
		Action lastaction = new AbstractAction("Last") {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(lastBut.getText().equals("Current"))
					{
						...
						//AppController.getLinesTableData().showCurrent();
					...
					else
					{
						...
						//AppController.getLinesTableData().showPrior();
		...
		Action openeraction = new AbstractAction("Opener") {
				...
				public void actionPerformed(ActionEvent e) {
					...
					else
					{
						...
						lastBut.setText("Last");
						//AppController.getLinesTableData().showOpener();
...
*/		
		...
		addBookieBut.addActionListener(new ActionListener() {
			 public void actionPerformed(ActionEvent ae)
			{
