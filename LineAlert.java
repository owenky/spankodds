...
public class LineAlert  implements ItemListener { 
		...
		JideToggleButton spreadupperright = new JideToggleButton(new ImageIcon("upperright.png"));
		JideToggleButton spreadupperleft = new JideToggleButton(new ImageIcon("upperleft.png"));
		JideToggleButton spreadlowerright = new JideToggleButton(new ImageIcon("lowerright.png"));
		JideToggleButton spreadlowerleft = new JideToggleButton(new ImageIcon("lowerleft.png"));
		
		JideToggleButton totalupperright = new JideToggleButton(new ImageIcon("upperright.png"));
		JideToggleButton totalupperleft = new JideToggleButton(new ImageIcon("upperleft.png"));
		JideToggleButton totallowerright = new JideToggleButton(new ImageIcon("lowerright.png"));
		JideToggleButton totallowerleft = new JideToggleButton(new ImageIcon("lowerleft.png"));
		
		JideToggleButton moneylineupperright = new JideToggleButton(new ImageIcon("upperright.png"));
		JideToggleButton moneylineupperleft = new JideToggleButton(new ImageIcon("upperleft.png"));
		JideToggleButton moneylinelowerright = new JideToggleButton(new ImageIcon("lowerright.png"));
		JideToggleButton moneylinelowerleft = new JideToggleButton(new ImageIcon("lowerleft.png"));
		
		JideToggleButton teamtotalupperright = new JideToggleButton(new ImageIcon("upperright.png"));
		JideToggleButton teamtotalupperleft = new JideToggleButton(new ImageIcon("upperleft.png"));
		JideToggleButton teamtotallowerright = new JideToggleButton(new ImageIcon("lowerright.png"));
		JideToggleButton teamtotallowerleft = new JideToggleButton(new ImageIcon("lowerleft.png"));
    ...
    { 
		...
		else if (e.getSource() == lanComboBox) 
		{
			// sportComboBox.getSelectedIndex()
				...
				totalaudioComboBox.setSelectedItem(""+lan.getTotalAudioFileName());
				...
				teamtotalaudioComboBox.setSelectedItem(""+lan.getTeamtotalAudioFileName());
				...
				moneylineaudioComboBox.setSelectedItem(""+lan.getMoneylineAudioFileName());
...
*/					
			...
			try {
					...
					if(allsports.endsWith(","))	allsports = allsports.substring(0,allsports.length()-1);
			...
			try 
			 {
				...
				if(allbookies.endsWith(","))	allbookies = allbookies.substring(0,allbookies.length()-1);
...
/*	 
  ...
  */
  ...
  LookAndFeelFactory.installJideExtension();
	...
	try { enablepopup.setSelected(Boolean.parseBoolean(prefs[0]));} catch(Exception ex) {}
	try { enablesound.setSelected(Boolean.parseBoolean(prefs[1]));} catch(Exception ex) {}
