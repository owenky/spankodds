...
public class MainScreen extends JPanel
{
	...
	Vector fixedtables = new Vector();//
	Vector renderers = new Vector();//
	Vector columns = new Vector();//
	Vector adjusters = new Vector();//
	Vector managers = new Vector();//
	
	Vector gamegroupheaders = new Vector();
	Vector vecofgamegroups = new Vector();
	
	Vector gamegroupLeagueID = new Vector();
	
	Vector inprogressgames = new Vector();
	Vector halftimegames = new Vector();
	Vector finalgames = new Vector();
	
	Vector inprogressgamessoccer = new Vector();
	Vector halftimegamessoccer = new Vector();
	Vector finalgamessoccer = new Vector();
	
	Vector seriesgames = new Vector();
	Vector ingamegames = new Vector();
	
	Vector seriesgamessoccer = new Vector();
	Vector ingamegamessoccer = new Vector();
	...
	LinesTableData halftimedatamodel;
	...
	public MainScreen(String name)
	{
		...
		//createMe(display,timesort,shortteam,opener,last);
	}
...
System.out.println("timer start");
	...
	// here i'm adding a blank column
		...
		//table0.setColumnModel(com.sia.client.ui.AppController.getColumnModel());
	...
	/*	if(name.equalsIgnoreCase("soccer"))
		...
		//fixed0.setColumnModel(com.sia.client.ui.AppController.getFixedColumnModel());
	...
	//	System.out.println(gamegroupLeagueID.get(j));
		...
		//com.sia.client.ui.AppController.addDataModel(dataModel);
		...
		if(isShowHeaders())
		{
			if(showit) tablePanel.add(label);
		}
		else
		{
