...
public TeamTotalline(int gid, int bid,double vo,double voj,double vu,double vuj,double ho,double hoj,double hu,double huj,java.sql.Timestamp ts,int p)
{
	this();
...
public TeamTotalline(int gid, int bid,double vo,double voj,double vu,double vuj,double ho,double hoj,double hu,double huj,java.sql.Timestamp ts,
double pvo,double pvoj,double pvu,double pvuj,double pho,double phoj,double phu,double phuj,java.sql.Timestamp pts,
double ovo,double ovoj,double ovu,double ovuj,double oho,double ohoj,double ohu,double ohuj,java.sql.Timestamp ots,int p)
{
	this();
	currentvisitover = vo;
...
double homeover,double homeoverjuice,double homeunder,double homeunderjuice,java.sql.Timestamp ts,boolean isopener)
{
