...
public class StockTableData extends AbstractTableModel {
  ...
  static final public ColumnData m_columns[] = {
    new ColumnData( "Symbol", 100, JLabel.RIGHT ),
...
public void setValueAt(Object value, int rowIndex, int colIndex) {
        StockData sd = (StockData)m_vector.get(rowIndex);
        switch (colIndex) {
            case 0:
				sd.m_symbol = (IconData)value;
                break;
            case 1:
                sd.m_name = (String)value;
                break;
            case 2:
                sd.m_last = (Double)value;
                break;
            case 3:
               sd.m_open = (Double)value;
                break;
            case 4:
                sd.m_change = (ColorData)value;
                break;
            case 5:
                sd.m_changePr = (ColorData)value;
                break;
			case 6:
                sd.m_volume = (Long)value;
                break;
			}
