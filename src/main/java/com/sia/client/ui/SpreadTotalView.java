	...
	public LineData[] getCurrentBoxes()
	{
	  ...
	  {		  
				if(visitspread == -99999)
				{
					...
					else
					{
						...
						if(tl.isBestOver()) {bottomborder += "bestover";}
						if(tl.isBestUnder()) {bottomborder += "bestunder";}
				...
				else if(visitspread < 0) // visitor is the favorite
				{
					...
					if(sl.isBestVisitSpread()) {topborder += "bestvisitspread";}
					if(sl.isBestHomeSpread()) {topborder += "besthomespread";}					
				...
				else if(visitspread > 0)
				{
					...
					else
					{
						...
						topcolor = totalcolor;
						if(tl.isBestOver()) {topborder += "bestover";}
						if(tl.isBestUnder()) {topborder += "bestunder";}												
						if(whowasbettotal.equals("u"))
						{
							topicon = ICON_DOWN;
						}
					...
					if(sl.isBestVisitSpread()) {bottomborder += "bestvisitspread";}
					if(sl.isBestHomeSpread()) {bottomborder += "besthomespread";}							
					if(whowasbetspread.equals("h"))
					{
						bottomicon = ICON_UP;
					}
		  ...
		  else
		  {
			  showcomebacks = false;
				...
				else if(visitmljuice < homemljuice) // visitor is the favorite
				{
					...
					topcolor = moneycolor;
					if(ml.isBestVisitMoney()) {topborder += "bestvisitmoney";}
					if(ml.isBestHomeMoney()) {topborder += "besthomemoney";}																			
				...
				else	
				{
					...
					if(ml.isBestVisitMoney()) {bottomborder += "bestvisitmoney";}
					if(ml.isBestHomeMoney()) {bottomborder += "besthomemoney";}																								
					if(whowasbetmoney.equals("h"))
					{
						bottomicon = ICON_UP;
					}
	  ...
	  {		  
				...
				else 
				{
					...
					if(ttl.isBestVisitOver()) {topborder += "bestvisitover";}
					if(ttl.isBestVisitUnder()) {bottomborder += "bestvisitunder";}																									
	  ...
	  {		  
				...
				else 
				{
					...
					if(ttl.isBestHomeOver()) {topborder += "besthomeover";}
					if(ttl.isBestHomeUnder()) {bottomborder += "besthomeunder";}																									
		...
		"<table border=1>"+
			...
			if(sl!= null)tooltiptext = tooltiptext+"<td align='left' >"+makeNullBlank(sl.getCurrentvisitspread()+"")+makeNullBlank(sl.getCurrentvisitjuice()+"")+"</td>";
			if(ml!= null)tooltiptext = tooltiptext+"<td align='left' >"+makeNullBlank(ml.getCurrentvisitjuice()+"")+"</td>";
			if(tl!= null)tooltiptext = tooltiptext+"<td align='left' >"+makeOverNullBlank(tl.getCurrentover()+"")+makeNullBlank(tl.getCurrentoverjuice()+"")+"</td>";
			tooltiptext = tooltiptext+"</tr>"+
					"<tr>";
					
			if(sl!= null)tooltiptext = tooltiptext+"<td align='left' >"+makeNullBlank(sl.getCurrenthomespread()+"")+makeNullBlank(sl.getCurrenthomejuice()+"")+"</td>";
			if(ml!= null)tooltiptext = tooltiptext+"<td align='left' >"+makeNullBlank(ml.getCurrenthomejuice()+"")+"</td>";
			if(tl!= null)tooltiptext = tooltiptext+"<td align='left' >"+makeUnderNullBlank(tl.getCurrentunder()+"")+makeNullBlank(tl.getCurrentunderjuice()+"")+"</td>";
			...
			"<td><table>"+
				"<tr>";
			if(sl!= null)tooltiptext = tooltiptext+"<td align='left' >"+makeNullBlank(sl.getPriorvisitspread()+"")+makeNullBlank(sl.getPriorvisitjuice()+"")+"</td>";
			if(ml!= null)tooltiptext = tooltiptext+"<td align='left' >"+makeNullBlank(ml.getPriorvisitjuice()+"")+"</td>";
			if(tl!= null)tooltiptext = tooltiptext+"<td align='left' >"+makeOverNullBlank(tl.getPriorover()+"")+makeNullBlank(tl.getPrioroverjuice()+"")+"</td>";

		tooltiptext = tooltiptext+"</tr>"+
					"<tr>";
		if(sl!= null)tooltiptext = tooltiptext+"<td align='left' >"+makeNullBlank(sl.getPriorhomespread()+"")+makeNullBlank(sl.getPriorhomejuice()+"")+"</td>";
		if(ml!= null)tooltiptext = tooltiptext+"<td align='left' >"+makeNullBlank(ml.getPriorhomejuice()+"")+"</td>";
		if(tl!= null)tooltiptext = tooltiptext+"<td align='left' >"+makeUnderNullBlank(tl.getPriorunder()+"")+makeNullBlank(tl.getPriorunderjuice()+"")+"</td>";
		tooltiptext = tooltiptext+"</tr>"+
				"</table></td>"+	
			
			"<td><table>"+
				"<tr>";
			if(sl!= null)tooltiptext = tooltiptext+"<td align='left' >"+makeNullBlank(sl.getOpenervisitspread()+"")+makeNullBlank(sl.getOpenervisitjuice()+"")+"</td>";
			if(ml!= null)tooltiptext = tooltiptext+"<td align='left' >"+makeNullBlank(ml.getOpenervisitjuice()+"")+"</td>";
			if(tl!= null)tooltiptext = tooltiptext+"<td align='left' >"+makeOverNullBlank(tl.getOpenerover()+"")+makeNullBlank(tl.getOpeneroverjuice()+"")+"</td>";
			
		tooltiptext = tooltiptext+"</tr>"+
			
				"<tr>";
			if(sl!= null)tooltiptext = tooltiptext+"<td align='left' >"+makeNullBlank(sl.getOpenerhomespread()+"")+makeNullBlank(sl.getOpenerhomejuice()+"")+"</td>";
			if(ml!= null)tooltiptext = tooltiptext+"<td align='left' >"+makeNullBlank(ml.getOpenerhomejuice()+"")+"</td>";
			if(tl!= null)tooltiptext = tooltiptext+"<td align='left' >"+makeUnderNullBlank(tl.getOpenerunder()+"")+makeNullBlank(tl.getOpenerunderjuice()+"")+"</td>";
