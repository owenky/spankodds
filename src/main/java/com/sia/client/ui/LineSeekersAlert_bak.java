...
public class LineSeekersAlert_bak extends AbstractLayeredDialog implements ItemListener {

    private static final Insets EMPTY_INSETS = new Insets(0, 0, 0, 0);
    boolean editing = false;
    LineAlertNode lan = null;
    JLabel welcome = new JLabel("LINE SEEKER ALERT");
    ...
    private final JPanel box1 = new JPanel();
    private final JPanel box2 = new JPanel();
    int popupsecs = 5;
   ...
   Vector<String> audiofilevec = new Vector<>();
    private GameSelectorPanel gameSelectorPanel = new GameSelectorPanel();
    ...
    private String alerttype = "Line Seeker Alert";


    public LineSeekersAlert_bak(SportsTabPane stp) {
...
//                BorderFactory.createEmptyBorder(10, 10, 10, 10));
//
//        box1.setLayout(new GridLayout(0,1));
//        box2.setLayout(new GridLayout(0,1));
//        box2.add();
//        box2.add();
//        box1.add();
//        box1.add();
        ...
        layoutUserComp(userComp);

        return userComp;
    }
    private void layoutUserComp(JPanel userComp) {
        final int mainColWidth = 4;
        final int titleHeight = 30;
        GridBagLayout gridBagLayout = new GridBagLayout();
        userComp.setLayout(gridBagLayout);
        GridBagConstraints gbc = new GridBagConstraints();

        gbc.fill = GridBagConstraints.NONE;
        //1. add column
        gbc.weightx = mainColWidth;
        gbc.anchor  = GridBagConstraints.EAST;
        gbc.gridx = 0;
        gbc.gridy = 0;
        JComponent addTitlePanel = Utils.createTitlePanel("Add New Seeker Alert");
        addTitlePanel.setPreferredSize(new Dimension(gameSelectorPanel.getPreferredWidth(),titleHeight));
        userComp.add(addTitlePanel ,gbc);

        gbc.gridx = 0;
        gbc.gridy = 1;
        gbc.gridheight = 3;
        userComp.add(gameSelectorPanel,gbc);
        ...
        gbc.gridy = 1;
        gbc.weightx = 1;
        userComp.add(Utils.createTitlePanel("OR") ,gbc);
        ...
        gbc.gridx = 2;
        gbc.gridy = 0;
        JComponent editTitlePanel = Utils.createTitlePanel("Edit Existing Seeker Alert");
        editTitlePanel.setPreferredSize(new Dimension(gameSelectorPanel.getPreferredWidth(),titleHeight));
        userComp.add(editTitlePanel ,gbc);

        gbc.gridx = 2;
        gbc.gridy = 1;
        lanComboBox.setPreferredSize(new Dimension(gameSelectorPanel.getPreferredWidth(),titleHeight));
        userComp.add(lanComboBox,gbc);
    }
