...
public class BestLines {
    ...
    public static void calculateconsensusspread(int gameid, int period) {
        ...
        if (consensussl == null) {
            ...
            AppController.addSpreadline(new Spreadline(lineIdentity, visitspread, spankymoneyline[0], homespread, spankymoneyline[1], 0));
        } else {
    ...
    public static void calculateconsensustotal(int gameid, int period) {
        ...
        if (consensustl == null) {
            LineIdentity lineIdentity = new LineIdentity(consensusbookieid,gameid,period);
            AppController.addTotalline(new Totalline(lineIdentity, bestbaseindex, spankymoneyline[0], bestbaseindex, spankymoneyline[1], 0));
        } else {
    ...
    public static void calculateconsensusmoney(int gameid, int period) {
        ...
        if (consensusml == null) {
            LineIdentity lineIdentity = new LineIdentity(consensusbookieid,gameid,period);
            AppController.addMoneyline(new Moneyline(lineIdentity, spankymoneyline[0], spankymoneyline[1], -99999, 0));
        } else {
    ...
    public static void calculateconsensusteamtotal(int gameid, int period) {
        ...
        if (consensustl == null) {
            LineIdentity lineIdentity = new LineIdentity(consensusbookieid,gameid,period);
            AppController.addTeamTotalline(new TeamTotalline(lineIdentity, bestbaseindexvisit, spankymoneylinevisit[0], bestbaseindexvisit, spankymoneylinevisit[1], bestbaseindexhome, spankymoneylinehome[0], bestbaseindexhome, spankymoneylinehome[1], 0));
        } else {
